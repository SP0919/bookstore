    ...
    <div
     ...
     box-sizing: border-box; font-family: 'Inter', Arial;">
        <div style="padding-top: 30px; padding-bottom: 20px;"><strong
                style="font-weight: 500; font-size:16px; font-family: 'Inter', Arial; ">Hey Admin 👋 </strong>
        </div>
        <div
            style="font-size: 15px;
         color: #111115; margin-bottom: 24px; font-family: 'Inter', Arial; line-height: 22px;">
            <p style="margin: 0px">Welcome to <b>Krios!</b></p>
            <p style="margin-top: 10px; margin-bottom:5px">The <b>{{$shop->title}}</b> shop has been request for approval.</p>
           
            <p style="margin-top: 10px; margin-bottom:5px"><b>See more details</b> <a href="{{$shop->url}}">{{$shop->url}}</a>
