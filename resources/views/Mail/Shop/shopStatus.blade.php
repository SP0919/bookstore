     ...
     box-sizing: border-box; font-family: 'Inter', Arial;">
        ...
        <div
         ...
         color: #111115; margin-bottom: 24px; font-family: 'Inter', Arial; line-height: 22px;">
            ...
            <p style="margin-top: 10px; margin-bottom:5px">You are Request for shop <b>{{$user->shop->title}}</b> has been {{$status}}</p>
            @if($status ==  "REJECTED")
            <p style="margin-top: 10px; margin-bottom:5px"><b>Reason</b> <br>
                {{$reason}}
            </p>
            @endif
            <br><br>
