...
<head>
    ...
    <title>Email Register Successfully</title>
    <link
...
<body style="font-family: 'Inter', Arial; color: #33334F; background-color: #fff; margin: 0;">
    ...
    <div class="logo" style="text-align: center; padding: 40px 0px ;">
        <img src="{{ $message->embed('assets/defaultImage/emailtemplate/krios-logo.svg') }}"
            alt="krios"style="width: 120px;" />
      </div> 
    <div
     ...
     box-sizing: border-box; font-family: 'Inter', Arial;">
        ...
        <div
         ...
         color: #111115; margin-bottom: 24px; font-family: 'Inter', Arial; line-height: 22px;">
            <p style="margin: 0px">Welcome to <b>Krios!</b></p>
            <p style="margin-top: 10px; margin-bottom:5px">You are now part of the Krios family! Get ready to depart on
                an exciting journey with us!</p>

            <p style="margin-top: 10px; margin-bottom:5px"> To make things extra special for you, starting today, we
                will send you a series of exclusive emails with amazing tips and tricks to get the most out of product.
            </p>

            <p style="margin-top: 10px; margin-bottom:5px"> If you prefer something more personal, you can always
